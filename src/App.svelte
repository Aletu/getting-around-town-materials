    ...
    <div class="flex-1 flex items-center gap-4">
      <div class="flex items-center gap-3">
        ...
        <div class="hidden xs:block">
          <span
            class="font-extrabold text-lg sm:text-xl text-base-content tracking-tight leading-tight block"
            >Getting Around Town</span
          >
          <span class="text-xs text-base-content/50 font-medium hidden sm:block"
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto w-full">
          <section class="space-y-12 lg:space-y-16">
            ...
            >
              ...
              <div
                class="absolute inset-0 bg-gradient-to-br from-base-100 via-base-100 to-primary/5 -z-10"
              >
                <div
                  class="absolute inset-0 bg-[radial-gradient(circle_at_70%_20%,rgba(101,195,200,0.08),transparent_50%)]"
                ></div>
                <div
                  class="absolute inset-0 bg-[radial-gradient(circle_at_30%_80%,rgba(239,159,188,0.06),transparent_50%)]"
                ></div>
              </div>
              ...
              >
                <div class="relative">
                  ...
                  <div
                    class="absolute -bottom-2 left-1/2 -translate-x-1/2 w-20 h-3 bg-base-content/5 rounded-full blur-sm"
                  ></div>
                </div>
                <div class="text-center lg:text-left max-w-xl">
                  ...
                  <button
                    class="btn btn-lg rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 border-none bg-gradient-to-r from-primary to-primary/90 text-primary-content gap-2 font-bold"
                    on:click={() => setView("learn")}
                  >
                    Start Learning
                    <svg
            ...
            >
              <div
                class="h-10 w-1.5 bg-gradient-to-b from-primary to-secondary rounded-full"
              ></div>
              <div>
                ...
                <p class="text-sm text-base-content/60 mt-1">
                  Choose an activity to practice your skills
                </p>
              </div>
            </div>
              ...
              >
                ...
                <div class="card-body relative p-6 lg:p-7">
                  ...
                  <div class="flex flex-col h-full relative z-10">
                    <div class="mb-5">
                      <div
                        class="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-4xl mb-5 group-hover:scale-110 group-hover:rotate-2 transition-transform duration-300 shadow-sm border border-primary/10"
                      >
                        💬
                      </div>
                      <h3
                      ...
                      <p class="text-sm text-base-content/60 leading-relaxed">
                        Read scenarios and guide visitors to the right place in
                        town.
                      </p>
                    </div>
                    ...
                    <div class="mt-auto pt-4">
                      ...
                      <button
                        class="btn btn-primary w-full rounded-xl shadow-sm group-hover:shadow-md transition-all font-semibold"
              ...
              >
                ...
                <div class="card-body relative p-6 lg:p-7">
                  ...
                  <div class="flex flex-col h-full relative z-10">
                    <div class="mb-5">
                      <div
                        class="w-16 h-16 rounded-2xl bg-secondary/10 flex items-center justify-center text-4xl mb-5 group-hover:scale-110 group-hover:-rotate-2 transition-transform duration-300 shadow-sm border border-secondary/10"
                      >
                        🚦
                      </div>
                      <h3
                      ...
                      <p class="text-sm text-base-content/60 leading-relaxed">
                        Order the steps to show a safe walking sequence.
                      </p>
                    </div>
                    ...
                    <div class="mt-auto pt-4">
                      ...
                      <button
                        class="btn btn-secondary w-full rounded-xl shadow-sm group-hover:shadow-md transition-all font-semibold"
              ...
              >
                ...
                <div class="card-body relative p-6 lg:p-7">
                  ...
                  <div class="flex flex-col h-full relative z-10">
                    <div class="mb-5">
                      <div
                        class="w-16 h-16 rounded-2xl bg-accent/10 flex items-center justify-center text-4xl mb-5 group-hover:scale-110 group-hover:rotate-2 transition-transform duration-300 shadow-sm border border-accent/10"
                      >
                        ❓
                      </div>
                      <h3
                    ...
                    <div class="mt-auto pt-4">
                      ...
                      <button
                        class="btn btn-accent w-full rounded-xl shadow-sm group-hover:shadow-md transition-all font-semibold text-accent-content"
