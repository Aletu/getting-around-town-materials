<!--
  Lightweight icon component. Centralises the most-reused inline SVGs so we
  ship each path once instead of dozens of times across components.
...
<script>
  ...
  /** @type {Record<string, { d: string, viewBox?: string, fill?: 'none' | 'currentColor' }>} */
  const ICONS = {
    back:        { d: "M10 19l-7-7m0 0l7-7m-7 7h18" },
    arrowRight:  { d: "M13 7l5 5m0 0l-5 5m5-5H6" },
    close:       { d: "M6 18L18 6M6 6l12 12" },
    check:       { d: "M5 13l4 4L19 7" },
    checkCircle: { d: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
    ...
    edit:        { d: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" },
    ...
    externalLink:{ d: "M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" },
  };
...
{#if icon}
  <svg
    ...
    focusable="false"
  >
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width={strokeWidth} d={icon.d} />
  </svg>
{/if}
