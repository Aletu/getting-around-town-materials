...
<div class="space-y-8 pb-12 max-w-6xl mx-auto">
  ...
  <div class="flex items-center gap-4 pt-4" in:fade={{ duration: 400 }}>
    <button
  ...
  <div class="text-center space-y-4" in:fade={{ duration: 400 }}>
    ...
    <p
      class="text-base sm:text-lg text-base-content/60 max-w-2xl mx-auto leading-relaxed"
    >
      There are so many important places in our town! Click on a card to learn
    ...
    <div class="flex flex-col items-center gap-5 max-w-3xl mx-auto pt-4">
      <div class="form-control w-full max-w-md relative group">
        ...
        />
        <div
          class="absolute left-4 top-1/2 -translate-y-1/2 text-base-content/40 group-focus-within:text-primary transition-colors pointer-events-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-5 w-5"
      ...
      <div class="flex flex-wrap justify-center gap-1.5">
        {#each categories as category}
          <button
            class="btn btn-sm rounded-lg transition-all font-medium {selectedCategory ===
            category
    ...
    {#each filteredPlaces as place (place.id)}
      ...
      >
        ...
        >
          <!-- Category Badge -->
          <div
            class="absolute top-2 right-2 badge badge-ghost badge-xs font-medium opacity-0 group-hover:opacity-100 transition-opacity"
          >
            {place.category}
          </div>
          ...
          <h2 class="font-bold text-sm sm:text-base mb-1 text-base-content">
            {place.label}
          </h2>
          <p
            class="text-xs text-base-content/50 line-clamp-2 leading-relaxed hidden sm:block"
          >
            {place.description}
          </p>

          <div
            class="mt-auto pt-2 text-primary text-xs font-semibold opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1"
          >
    ...
    >
      ...
      >
        ...
        <div class="absolute inset-0 overflow-hidden">
          <div
            class="absolute -top-16 -left-16 w-32 h-32 bg-primary/10 rounded-full blur-3xl"
          ></div>
          <div
            class="absolute -bottom-16 -right-16 w-32 h-32 bg-secondary/10 rounded-full blur-3xl"
          ></div>
        </div>
      ...
      <div class="card-body items-center text-center pt-10 pb-6 px-6 relative">
        ...
        <div class="badge badge-primary badge-sm font-medium mb-2">
        ...
        <div
          class="bg-base-200/50 p-4 sm:p-5 rounded-xl w-full border border-base-200/50"
        >
        ...
        <div class="card-actions mt-6 w-full">
          <button
            class="btn btn-primary btn-block rounded-xl font-semibold shadow-sm hover:shadow-md transition-all"
            on:click={closePlace}
          >
            Got it!
          </button>
